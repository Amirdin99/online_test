...
class _MyProfilePageState extends State<MyProfilePage> {
  ...
  Future<dynamic> getUserRegion()async {
    final response = await UserRepositories.getInstance().getUserRegion();
    regoinsDetiles = response;
    setState(() {});
  }
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: GestureDetector(
                                    onTap: () async {
                                      final response = UserRepositories
                                              .getInstance()
                                          .editUserProfile(
                                              username: _emileController.text,
                                              ...
                                              phone: _phoneNumberController.text
                                                  .replaceAll("+", ""),
                                              additional_phone:
                                                  _secondPhoneNumberController
                                                      .text
                                                      .replaceAll("+", ""),
                                              region: regoinsDetiles['results'][_value]['id'] ?? 27,
                                              district:
                                                  _districNameController.text,
                                              address:
                                                  _addresNameController.text);
                                    },
                                    child: Container(
                                      height: 50,
                                      width: double.infinity,
